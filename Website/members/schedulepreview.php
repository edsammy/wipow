...
<html>
	<head>
		...
		<link href="../css/indextest.css" rel="stylesheet"/>
	...
	<body>
		<div class="topbar"><h1>&nbsp;&nbsp;&nbsp;&nbsp;Schedule Data Collection <span style="font-weight:lighter">From Wireless Power Monitor Devices&nbsp;</span></h1></div>
				
		<form id="bigform" name="myform" onsubmit="return OnSubmitForm();" method="post" target="_blank">
		<div id="deviceselect1">
			Click <a href="../definitions.html" target="_new" onclick="javascript:void window.open('../definitions.html','1371063848022','width=700,height=320,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;"><span style="text-decoration:none;color:rgb(8,106,135);">here</span> </a>to see definitions for each measurement<br><Br>
		...
		<div id="timefield2">
			...
			<legend id="bigboxtitle" style="border-radius:5px;"><b>&nbsp;Please enter the time period for scheduled data collection:&nbsp;</b><br></legend>
			<table>
					<tr><td></td><td></td><td class="centered">Hour</td><td class="centered">Minute</td><td class="centered">Second</td></tr>
					<tr><td nowrap>Start Date/Time: </td>
						<td>
