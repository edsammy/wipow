...
<html>
	<head>
		...
		<link href="livepreviewcss.css" rel="stylesheet" type="text/css" />
	...
	<div class="topbar">
		...
		<Br><br>
			<fieldset style="border-radius:5px;margin-left:72px;">
			<legend style="color:rgb(8,106,135);font-size:18px;font-weight:lighter;"><b>enter the time period of the recorded data you want to view:</b></legend>
			<table>
			...
			<br><br>
			<input type="submit" name="submit" onclick="document.pressed=this.value" value="Get All Data" /><em class="warn">&nbsp;&nbsp;This will show all measurements from the selected time period (Table only).</em>
			<br>
			&nbsp;&nbsp;or
			<br>
		...
		<fieldset style="border-radius:5px;">
			...
			<table>
				<tr>
					<td>
						<fieldset id="phaseboxa" style="border-radius:5px;">
					...
					<td>
						<fieldset id="phaseboxb" style="border-radius:5px;">
					...
					<td>
						<fieldset id="phaseboxc" style="border-radius:5px;">
